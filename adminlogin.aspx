...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="style3">
        <tr>
            <td class="style4">
                <asp:Image ID="Image2" runat="server" Height="194px" ImageUrl="~/key.png" 
                    Width="277px" />
            </td>
            <td>
                <asp:Label ID="Label2" runat="server" 
                    style="font-style: bold; font-size: 39px; font-family: 'Blackadder ITC'; color: #660033; font-weight: 700;" 
                ...
                <table class="style3">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="158px" 
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    Width="154px" BackColor="#ff0000" ForeColor="White" 
