...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    BorderStyle="Groove" Height="135px" style="margin-left: 348px" Width="569px">
        <table class="style3">
            <tr>
                <td class="style5">
                    UserName</td>
            ...
            <tr>
                <td class="style5">
                    Password</td>
                <td>
                    <asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="135px" 
            ...
            <tr>
                <td class="style5">
                    &nbsp;&nbsp;</td>
                <td>
                    <asp:Button ID="Button1" runat="server" BackColor="#ff0000" ForeColor="White" 
